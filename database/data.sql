...
VALUES
('sedan_toyota_camry.jpg', 'Toyota Camry', 'Reliable and comfortable sedan', 45.00, 1, 1),
('sedan_honda_accord.jpg', 'Honda Accord', 'Spacious sedan with smooth driving', 48.00, 1, 1),

('suv_toyota_rav4.jpg', 'Toyota RAV4', 'Compact SUV suitable for city and travel', 65.00, 1, 2),
('suv_bmw_x5.jpg', 'BMW X5', 'Luxury SUV with powerful performance', 120.00, 1, 2),

('hatchback_vw_golf.jpg', 'Volkswagen Golf', 'Compact hatchback for urban driving', 40.00, 1, 3),
('hatchback_ford_fiesta.jpg', 'Ford Fiesta', 'Economic and easy-to-drive hatchback', 35.00, 1, 3),

('sports_porsche_911.jpg', 'Porsche 911', 'High-performance sports car', 250.00, 1, 4),
('sports_ford_mustang.jpg', 'Ford Mustang', 'Iconic American muscle car', 180.00, 0, 4),

('luxury_mercedes_sclass.jpg', 'Mercedes S-Class', 'Top luxury sedan with premium comfort', 220.00, 1, 5),
('luxury_bmw_7series.jpg', 'BMW 7 Series', 'Executive luxury car', 200.00, 1, 5),

('electric_tesla_model3.jpg', 'Tesla Model 3', 'Fully electric car with autopilot features', 90.00, 1, 6),
('electric_nissan_leaf.jpg', 'Nissan Leaf', 'Affordable electric vehicle', 70.00, 1, 6),

('hybrid_toyota_prius.jpg', 'Toyota Prius', 'Fuel-efficient hybrid car', 60.00, 1, 7),
('hybrid_honda_insight.jpg', 'Honda Insight', 'Modern hybrid sedan', 62.00, 1, 7),

('convertible_mini.jpg', 'Mini Cooper Convertible', 'Stylish convertible for city rides', 85.00, 1, 8),
('convertible_bmw_z4.jpg', 'BMW Z4', 'Sporty luxury convertible', 150.00, 0, 8),

('coupe_audi_a5.jpg', 'Audi A5 Coupe', 'Elegant coupe with sporty look', 110.00, 1, 9),
('coupe_mercedes_c.jpg', 'Mercedes C Coupe', 'Premium compact coupe', 115.00, 1, 9),

('pickup_ford_ranger.jpg', 'Ford Ranger', 'Strong pickup for transport and work', 75.00, 1, 10),
('pickup_toyota_hilux.jpg', 'Toyota Hilux', 'Reliable pickup for heavy usage', 80.00, 1, 10);
