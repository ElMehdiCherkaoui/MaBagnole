...
<body class="bg-gray-900 text-gray-100 min-h-screen font-sans flex">
            ...
            <table class="min-w-full bg-gray-800 rounded-xl border border-gray-700">
                ...
                <tbody class="text-gray-100">
                    <tr class="border-b border-gray-700 hover:bg-gray-700 transition">
                        ...
                        <td class="px-6 py-4">How to Maintain Your Car</td>
                        ...
                        <td class="px-6 py-4 flex gap-2">
                            <button
                                ...
                                data-id="1" data-title="How to Maintain Your Car">
                                Edit
                            </button>
                            <button
                                class="px-3 py-1 bg-green-600 hover:bg-green-700 rounded text-white font-semibold approveBtn"
                                data-id="1">
                                Approve
                            </button>
                            <button
                                class="px-3 py-1 bg-red-600 hover:bg-red-700 rounded text-white font-semibold rejectBtn"
                                data-id="1">
                                Reject
                            </button>
    ...
    <div id="addArticleModal" class="flex fixed inset-0 bg-black bg-opacity-70 hidden items-center justify-center z-50">
        <div class="bg-gray-900 w-full max-w-md rounded-xl border border-gray-700 p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <button id="closeAddArticleModal" class="text-gray-400 hover:text-white text-xl">&times;</button>
            </div>

            <form method="POST" action="articles.php" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="articleContent" required
